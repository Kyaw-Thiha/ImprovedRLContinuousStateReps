...
for i in range(20):
    pre_comment_ = f"rep={representation_name}, reward_center={reward_center_mode}, eta={reward_center_eta}, run={i}"
    ...
    post_comment = f"rep={representation_name}, reward_center={reward_center_mode}, eta={reward_center_eta}, run={i}"
