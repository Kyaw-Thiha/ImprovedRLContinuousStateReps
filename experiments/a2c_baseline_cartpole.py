...
np.save('../data/baseline-comparison/baseline_num_timesteps.npy', np.array(x_s, dtype=object), allow_pickle=True)
np.save('../data/baseline-comparison/baseline_rewards.npy', np.array(y_s, dtype=object), allow_pickle=True)
