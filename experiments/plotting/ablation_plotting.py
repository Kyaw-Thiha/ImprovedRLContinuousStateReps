...
CONDITION_COLORS = {
    ("Discrete", "none"): "#8aaed1",
    ("Discrete", "simple"): "#e0c27a",
    ("Discrete", "value"): "#d78888",
    ("PlaceSSP", "none"): "#8aaed1",
    ("PlaceSSP", "simple"): "#e0c27a",
    ("PlaceSSP", "value"): "#d78888",
    ("TileCoding", "none"): "#8aaed1",
    ("TileCoding", "simple"): "#e0c27a",
    ("TileCoding", "value"): "#d78888",
}
CONDITION_LINE_COLORS = {
    ("Discrete", "none"): "#597fa8",
    ("Discrete", "simple"): "#ad8d44",
    ("Discrete", "value"): "#ab5d5d",
    ("PlaceSSP", "none"): "#597fa8",
    ("PlaceSSP", "simple"): "#ad8d44",
    ("PlaceSSP", "value"): "#ab5d5d",
    ("TileCoding", "none"): "#597fa8",
    ("TileCoding", "simple"): "#ad8d44",
    ("TileCoding", "value"): "#ab5d5d",
}
...
def condition_line_colors(conditions, condition_col):
    if condition_col == "reward_center_mode":
        return {
            condition.key: CONDITION_LINE_COLORS.get((condition.rep, condition.condition_value), "#4e79a7")
            for condition in conditions
        }
...
def plot_learning_curves(
    ...
    line_colors = condition_line_colors(conditions, condition_col)
    ...
    for condition in conditions:
        ...
        ax.plot(
            ...
            y,
            lw=2.4,
            color=line_colors[condition.key],
